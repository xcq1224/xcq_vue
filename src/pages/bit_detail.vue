<template>
    <div class="page"> 
        ...
        <div class="main">
            <div class="hot-card">
                ...
                <div class="pictures-box" v-if="params.contentType==1 && params.imgUrl_2">
                    <div v-show="params.imgUrl_1"><img :src="params.imgUrl_1" alt="" @click="openPicture(0, params.imgUrl_1, params.imgUrl_2, params.imgUrl_3)"></div>
                    <div v-show="params.imgUrl_2"><img :src="params.imgUrl_2" alt="" @click="openPicture(1, params.imgUrl_1, params.imgUrl_2, params.imgUrl_3)"></div>
                    <div v-show="params.imgUrl_3"><img :src="params.imgUrl_3" alt="" @click="openPicture(2, params.imgUrl_1, params.imgUrl_2, params.imgUrl_3)"></div>
                </div>
                <div class="pictures-box" v-if="params.contentType==1 && !params.imgUrl_2">
        ...
        <popup v-model="showShare" @on-show="showPopup">
            <div class="popup">
                <div class="share-box">
