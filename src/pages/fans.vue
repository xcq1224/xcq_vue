<template>
    <div class="page"> 
        <x-header class="pst" :left-options="{backText: ''}">我的粉丝</x-header>
        <div class="main">
            <div class="talent-card" @click="toHomepage(item.towerUserId)" v-for="(item, index) in fansList" :key="index">
